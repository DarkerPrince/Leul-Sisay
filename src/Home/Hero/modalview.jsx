...
export default function Modal() {
  ...
  return (
    <>
      <button
        className="bg-leulePrime hover:shadow-md hover:bg-red-800 active:bg-leulePrime/80 font-leuleFont text-white font-semibold text-sm px-6 py-3  shadow-xs outline-none focus:outline-none mr-1 mb-1 mt-4 rounded-full ease-linear transition-all duration-150"
        type="button"
            ...
            <div className="relative  w-full md:w-1/2 my-6 mx-auto max-w-3xl">
              ...
              <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-slate-800/80 outline-none focus:outline-none">
               ...
               <p class="mb-2 lg:mb-2 font-light text-start text-slate-600 sm:text-lg">Ready to do great things with you.</p>
                    ...
                    <RiCloseLine onClick={() => setShowModal(false)} className="cursor-pointer float-right h-6 w-6 text-white/50"/>
