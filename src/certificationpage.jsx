...
function CertificationPage() {
  return (
    <div
      id="my_certificate"
      className="flex flex-col bg-slate-800 text-center bg-contain bg-no-repeat"
      style={{ backgroundImage: `url(${leftdecor})` }}
    >
      <h1 className="flex flex-col text-4xl font-semibold text-leulePrime">
        Certification
      </h1>
      <div className="flex items-center text-justify lg:flex-row flex-col w-[50vw] bg-white/5 text-white shadow-lg rounded-lg    lg:w-[70vw] mx-auto justify-start mt-8 px-0">
        <img
          className="lg:w-1/3 w-full rounded-xl bg-contain
